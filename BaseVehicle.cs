...
namespace Base
{
    ...
    public abstract class BaseVehicle : IVehicle
    {
        ...
        public void GoAir()
        {
            if (this is AirVehicle && speed.TranslateTerrainSpeed(movingThrough, IVehicle.Terrain.Air)>=20)
            {
        ...
        public override string ToString()
        {
            ...
            if (this is GroundVehicle) sb.Append("Ground, ");
            if (this is WaterVehicle) sb.Append("Water, ");
            if (this is AirVehicle) sb.Append("Air, ");
            sb.AppendLine();
            ...
            if (this is GroundVehicle gVehicle) sb.AppendLine($"Number of Wheels: {gVehicle.numOfWheels}");
            if (this is WaterVehicle wVehicle) sb.AppendLine($"Displacement: {wVehicle.displacement} m^3");
