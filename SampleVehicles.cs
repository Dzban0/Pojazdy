...
{
    public class Car : BaseVehicle, GroundVehicle
    {
    ...
    public class Plane : BaseVehicle, GroundVehicle, AirVehicle
    {
        public int numOfWheels { get; private set; }
    ...
    public class ATV : BaseVehicle, GroundVehicle, AirVehicle
    {
        public int numOfWheels { get; private set; }
